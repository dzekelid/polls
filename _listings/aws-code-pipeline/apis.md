...
created: "2018-08-28"
modified: "2018-08-28"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/polls/master/_listings/aws-code-pipeline/apis.md
...
- name: AWS Code Pipeline API - Poll For Jobs
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/polls/master/_listings/aws-code-pipeline/actionpollforjobs-get-openapi.md
- name: AWS Code Pipeline API - Poll For Third Party Jobs
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/polls/master/_listings/aws-code-pipeline/actionpollforthirdpartyjobs-get-openapi.md
x-common:
- type: x-api-gallery
